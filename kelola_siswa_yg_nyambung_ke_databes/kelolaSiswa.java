...
public class kelolaSiswa {
    ...
    private static void displayMenu() {
        ...
        System.out.println(" 1. tanbah siswa baru");
        System.out.println(" 2. perbaharui data siswa");
    ...
    private static void tambahSiswa(Connection connection) {
        try {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                System.out.println("# siswa baru berhasil di tambahkan #");
            }
        } catch (SQLException e) {
    ...
    private static void perbaruiDataSiswa(Connection connection) {
        try {
            ...
            System.out.print("Masukkan NIS siswa yang mau diperbarui: ");
